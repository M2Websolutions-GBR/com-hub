...
exports.updateReply = asyncHandler(async (req, res, next) => {
  ...
  if (
    ...
    reply.commentId.videoId.userId.toString() != req.user.id.toString()
  ) {
...
// @desc    Delete comment
// @route   DELETE /api/data/replies/:id
// @access  Private
